...
#define SIGNOND_DAEMON_INTERFACE        SIGNOND_STRING(SIGNOND_DAEMON_INTERFACE_C)
#define SIGNOND_IDENTITY_INTERFACE      SIGNOND_STRING(SIGNOND_IDENTITY_INTERFACE_C)
#define SIGNOND_AUTH_SESSION_INTERFACE  SIGNOND_STRING(SIGNOND_AUTH_SESSION_INTERFACE_C)
...
#define SIGNOND_REFERENCE_NOT_FOUND_ERR_STR SIGNOND_STRING("Reference not found.")
#define SIGNOND_REFERENCE_NOT_FOUND_ERR_NAME SIGNOND_STRING(SIGNOND_ERR_PREFIX "ReferenceNotFound")
...
#define  SIGNOND_SESSION_CLOSED_ERR_STR SIGNOND_STRING("Session closed by user.")
#define  SIGNOND_SESSION_CLOSED_ERR_NAME SIGNOND_STRING(SIGNOND_ERR_PREFIX "SessionClosed")
...
#define SIGNOND_TOS_NOT_ACCEPTED_ERR_STR SIGNOND_STRING("User declined Terms of Service.")
#define SIGNOND_TOS_NOT_ACCEPTED_ERR_NAME SIGNOND_STRING(SIGNOND_ERR_PREFIX "TOSNotAccepted")

#define SIGNOND_FORGOT_PASSWORD_ERR_STR SIGNOND_STRING("User selected forgot password.")
#define SIGNOND_FORGOT_PASSWORD_ERR_NAME SIGNOND_STRING(SIGNOND_ERR_PREFIX "ForgotPassword")

#define SIGNOND_INCORRECT_DATE_ERR_STR SIGNOND_STRING("The Date set is not correct")
#define SIGNOND_INCORRECT_DATE_ERR_NAME SIGNOND_STRING(SIGNOND_ERR_PREFIX "IncorrectDate")
